...
</head><body id="foxeslab-email" style="overflow-x: hidden;">
<ul id="foxeslab-template-elements" class="ui-sortable" style="margin: 0px; padding: 0px; list-style: none;">

<li class="ui-sortable-handle" style="width: 100%; height: auto;">
                    ...
                    <table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                        ...
                        <tr>
                            <td align="center">
                                <div class="editable-img">
                                    <img editable="true" mc:edit="image003" src="http://castellab.com/emails/notificationapp/images/circle-icon-tag.png" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td mc:edit="text001" align="center" class="text_color_ffffff" style="color: #ffffff; font-size: 30px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                <div class="editable-text"><multiline>Nueva solicitud de factura</multiline></div>
                            </td>
                        </tr>
                    ...
                    <table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                            ...
                            <td mc:edit="text003" align="left" class="center_content text_color_282828" style="color: #282828; font-size: 18px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                <div class="editable-text">
                                    <span class="text_container">
                                        <multiline>Una persona solicitado su factura con la siguiente información: </multiline>
                                    </span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                    ...
                                    <tbody><tr>
                                        <td align="center">
                                            <div style="border-style: none !important; display: block; border: 0 !important;" class="editable-img">
                                                <img editable="true" mc:edit="image004" src="http://castellab.com/emails/notificationapp/images/circle-icon-user-2.png" style="display:block; line-height:0; font-size:0; border:0;" border="0" alt="">
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <!-- column-2  -->
                                <table class="table1-2 bg_color_fafafa" width="374" bgcolor="#fafafa" align="right" border="0" cellspacing="0" cellpadding="0" style="border-collapse:separate; border: 1px solid #ccc; border-radius: 10px; padding: 20px;">
                                    <tbody><tr>
                                    ...
                                    <tr>
                                        <td mc:edit="text007" align="left" class="text_color_b0b0b0" style="color: #b0b0b0; font-size: 14px;line-height: 1.5; font-weight: 300; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                            <div class="editable-text" style="line-height: 1.5;">
                                                <span class="text_container">
                                                    <multiline>
                                                    <strong>ID de factura:</strong> {{$id}}
                                                    </multiline>
                                                </span>
                                            </div>
                                        </td>
            ...
            <tr>
                <td>
                    ...
                    <table class="table1-2" width="350" align="left" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td mc:edit="text011" align="left" class="center_content" style="font-size: 14px;font-weight: 400; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                <div class="editable-text">
                                    <span class="text_container">
                                        <multiline>
